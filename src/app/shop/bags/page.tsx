  ...
  return (
    <div className="min-h-screen bg-[#F7F3EC]">
      <div className="bg-[#3E2A1E] pt-28 md:pt-36 pb-14 md:pb-20 px-6 md:px-12">
        ...
        <h1 className="font-['Playfair_Display',serif] text-5xl md:text-7xl text-[#F7F3EC]">Bags</h1>
      </div>
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-12">
        <div className="flex gap-6 border-b border-[#6B4C3B]/10 pb-6 mb-12">
          ...
          <a href="/shop/bags" className="text-[11px] tracking-[0.2em] uppercase text-[#3E2A1E] border-b border-[#3E2A1E] pb-1">Bags</a>
        </div>
