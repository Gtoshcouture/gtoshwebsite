    ...
    <div className="min-h-screen bg-[#F7F3EC] pt-28 md:pt-36">
      <div className="max-w-[1400px] mx-auto px-6 md:px-16">
        ...
        <div className="mb-14 md:mb-20">
          ...
          <h1 className="font-['Cormorant_Garamond',serif] text-5xl md:text-7xl text-[#3E2A1E]">All Pieces</h1>
        </div>

        {/* Filter row */}
        <div className="flex gap-6 border-b border-[#6B4C3B]/10 pb-6 mb-12">
          <a href="/shop" className="text-xs tracking-[0.2em] uppercase text-[#3E2A1E] border-b border-[#3E2A1E] pb-1">All</a>
